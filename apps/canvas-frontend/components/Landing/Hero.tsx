      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <Link href={"/signin"}>
              <Button variant={"primary"} size="lg" className="h-12 px-6 flex  justify-center items-center rounded outline-none text-white">
                Sign in
                <Pencil className="ml-2 h-4 w-4" />
              </Button>
            </Link>
            <Link href="/signup">
              <Button variant="outline" size="lg" className="h-12 px-6  rounded hover:bg-gray-100">
                Sign up
              </Button>
            </Link>
          </div>
